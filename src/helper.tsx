...
export const BUBBLES_DATA = [
  ...
  {
    position: { top: 25, left: (width - BALL_SIZE) / 2 },
    color: "#4d92f1",
  ...
  {
    position: { top: BOTTOM_HALF_HEIGHT / 2 - BALL_SIZE / 2, left: (width * 3) / 4 - BALL_SIZE / 2 },
    color: "#7add7b",
  ...
  {
    position: { bottom: 5, left: (width - BALL_SIZE) / 2 },
    color: "#f5984f",
